...
<!--chats -->
      <div class="chat-list">
        <div class="chat-box">
          <div class="img-box">
            <img class="img-cover" src="./assets/img/profilepic.jpeg" alt="logo">
          </div>
...
<!--header -->
      <div class="header">
        <div class="img-text">
          <div class="user-img">
          <img class="dp" src="./assets/img/profilepic.jpeg" alt="logo">
        </div>
          <h4>Param<br><span>Online</span></h4>
        </div>
        <div class="nav-icons">
...
<!--chat-container -->
      <div class="chat-container">
        <div class="message-box my-message">
          <p>About today's ride, it was a great experience. Thanks A Lot<br><span>07:43</span></p>
        </div>
        <div class="message-box friend-message">
          <p>Same. I would be happy to go on another next time.<br><span>07:45</span></p>
        </div>
        <div class="message-box friend-message">
          <p>How about a movie night on Monday.<br><span>07:45</span></p>
        </div>
        <div class="message-box friend-message">
          <p>Beats me. How about Tuesday?<br><span>07:45</span></p>
        </div>
        <div class="message-box my-message">
          <p>Yeah Sure<br><span>07:46</span></p>
        </div>
        <div class="message-box my-message">
          <p>Mee too! 😊<br><span>07:46</span></p>
        </div>
      <div class="message-box friend-message">
          <p>Ok i'll post it soon.<br><span>07:48</span></p>
        </div>
        <div class="message-box my-message">
      ...
      <div class="message-box friend-message">
          <p>Awesome! I'll have a chat with you in a few.<br><span>07:49</span></p>
        </div>
        <div class="message-box friend-message">
          <p>I am inviting you to share wheels with me --hyperlink-here---<br><span>07:55</span></p>
        </div>
      </div>
